...
SFEIR School How to, explication des concepts de comment faire une school / formation avec la librairie `sfeir-school-theme`

# Slides

You can view the slides [here](https://sfeir-open-source.github.io/sfeir-school-howto/).
